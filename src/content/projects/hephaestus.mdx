...
status: "active"
featured: false
summary: "<strong>Dual-socket Xeon</strong> lab machine for adversarial network research and trusted compute. Platform integrates GPU passthrough, 40 Gb/s InfiniBand fabric, and VM isolation for security simulations.<ul><li>Tesla P40 (24GB VRAM) with VFIO</li><li>InfiniBand loop via 2× ConnectX-3 HCAs</li><li>Proxmox VE with attacker/victim/sensor VMs</li></ul>"
artifacts:
...
images:
  ...
  - "/artifacts/hephaestus/IMG_3545.webp"
...
**Hardware bring-up**
- [DU99D4: Memory Init Failure](/logbook/2025-10-04-du99d4-memory-init)
- [BIOS Reflash (ZX-DU99D4 V1.12)](/logbook/2025-10-05-bios-reflash)
- [Intel i350-T4 Soft-Brick & NVM-Level Recovery](/logbook/2025-10-15-i350-recovery)

**Networking & infrastructure**
- [Lab Topology Baseline](/logbook/2026-01-27-lab-topology)
- [Proxmox Host Networking](/logbook/2026-01-27-proxmox-networking)
- [Bastion VM Build (Debian 12)](/logbook/2026-01-27-bastion-build)
- [CUDA VM Networking](/logbook/2026-01-27-cuda-vm-networking)
- [Controlled Egress Scripts](/logbook/2026-01-27-egress-control)

**LLM stack**
- [GLM-4.7 + Tesla P40 + llama.cpp: First LLM on Hephaestus](/logbook/2026-01-26-glm47-p40-llamacpp)
- [LLM Stack: llama.cpp + Qwen2.5-32B + Open WebUI](/logbook/2026-01-27-llm-stack-qwen)

**InfiniBand**
- [M.2→PCIe Adapter Saga](/logbook/2026-02-03-m2-adapter-pcie-saga)
- [Dual ConnectX-3 Pro Operational](/logbook/2026-02-09-dual-hca-operational)
- [Dual HCA Burn-in Procedure](/logbook/2026-02-09-dual-hca-burnin-plan)

**Thermal**
- [P40 Heatsink Install + Context Tuning (96k/q4_0)](/logbook/2026-02-28-qut-p40-heatsink)

**Control plane**
- [HephaestusBar: macOS Menu Bar Dashboard](/logbook/2026-03-25-hephaestus-bar)
